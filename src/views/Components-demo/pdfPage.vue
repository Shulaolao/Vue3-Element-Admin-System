<template>
  <div v-if="!url" v-loading.fullscreen.lock="fullscreenLoading" class="main-article"
...
const fetchData = async () => {
  const res = await import('./pdfContent')
  const { title } = res.default
  document.title = title
  article.value = res.default
  setTimeout(() => {
